  ...
  static List<ArticleModel> FetchAll() {
    return [
      ...
      ArticleModel(
          ...
          <ArticleContent>[
            ArticleContent("By Greta Gilbertson","Citizenship is a multidimensional concept that means membership in a specific nation-state and the formal rights and obligations that this membership entails. Citizenship can also be understood as a status and an identity. The principle premise of citizenship is that nation-states can set and control the parameters of membership."),
      ...
      ArticleModel(
          ...
          <ArticleContent>[
            ArticleContent("By Anup Shah", "Racism is the belief that characteristics and abilities can be attributed to people simply on the basis of their race and that some racial groups are superior to others. Racism and discrimination have been used as powerful weapons encouraging fear or hatred of others in times of conflict and war, and even during economic downturns."),
          ]
      ...
      ArticleModel(
          ...
          <ArticleContent>[
            ArticleContent("By Brette Sember"," It’s a legal ID If you lose your driver’s license, your passport serves as a legal photo ID for any situation that might require one. (However, it does not prove your legal driving status, should you get pulled over on a driving violation.)"),
          ]
      ),
      ArticleModel(
