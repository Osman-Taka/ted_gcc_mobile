  ...
  static List<ArticleModel> FetchAll() {
    return [
      ...
      ArticleModel(
          ...
          <ArticleContent> [
            ArticleContent(" By Dr. Stephanie Allen ", " No longer passive participants in their health care, consumers are demanding transparency, convenience, access, and personalized products and services—similar to other aspects of their lives. It is, therefore, important for health systems to morph their strategies accordingly.Some health systems are doing this by transitioning certain inpatient procedures from inside hospital walls to less acute outpatient settings such as ambulatory care centers, retail clinics, community health centers, and even people’s homes. Some others are using virtual health—connecting clinicians with patients (and with other clinicians and stakeholders) through telecommunication and networked technologies—to remotely deliver health care services and support well-being."),
          ]
      ),
      ArticleModel(
          ...
          <ArticleContent> [
            ArticleContent(" By Jorg Schalekamp", "Marine plastic pollution does not only have ecological ill-effects, it can also affect businesses and governments economically. The fight against plastic waste is not lost, and organizations and governments stand to save – or even gain –from taking action.Plastic waste spewing from rivers into oceans around the world has reached an estimated 0.8-2.7 million metric tons per year.1 As the problems mounted, we all became aware of the direct consequences – the ecological impact of marine plastic pollution is well known and documented. What’s often evading attention are the financial considerations. The pollution is creating a severe economic impact on industries linked to the blue economy,2 as well as governments. There could be as much financial urgency as ecological urgency where marine plastic pollution is concerned.."),
          ]
      ),
      ArticleModel(
          "What is Hunger ?",
